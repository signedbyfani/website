---
title: "Design Process Course Work - Mental Health"
time:
  created: "5 December 2024"
  updated: "5 December 2024"
summary: "Help individuals assess their mental health condition through accessible tools and connecting them with appropriate care to ensure timely support and recovery"
media:
  thumbnail: "/dp/cover.jpg"
---
...
<Image src="/dp/secondary-research.png" alt="Secondary Research" caption="Secondary Research" width={4000} height={3000}/>

## Interaction with Professionals 
To ground our research, we spoke to mental health professionals who shared invaluable insights
<Image src="/dp/counselors.png" alt="Insights from Counselors" caption="Insights from Counselors" width={4000} height={3000}/>
...
<Image src="/dp/users.png" alt="Insights from people" caption="Insights from people" width={4000} height={3000}/>
...
## How might we's?
<Image src="/dp/how-might-we.png" alt="How might we's?" caption="How might we's?" width={4000} height={3000}/>

## Ideation
We drafted some ideas and then categorized them into digital and non-digital solutions,
<Image src="/dp/non-digitalpng" alt="Non-Digital Solutions" caption="Non-Digital Solutions" width={4000} height={3000}/>
<Image src="/dp/digital.png" alt="Digital Solutions" caption="Digital Solutions" width={4000} height={3000}/>
...
<Image src="/dp/physical-flow.png" alt="Physical Solution's Flow" caption="Flow of the Physical Part of the solution" width={4000} height={3000}/>
<Image src="/dp/digital-flow.png" alt="Digital Solution's Flow" caption="Flow of the proposed digital application" width={4000} height={3000}/>
...
<Image src="/dp/card-1.png" alt="Manual Mockup" caption="Mockup of the manual" width={4000} height={3000}/>
<Image src="/dp/card-2.png" alt="Manual Mockup" caption="Mockup of the manual" width={4000} height={3000}/>
...
<Image src="/dp/ui1.png" alt="Low Fidelity Prototypes 1" caption="Onboarding, Questionnaire and additional screens" width={4000} height={3000}/>
<Image src="/dp/ui2.png" alt="Low Fidelity Prototypes 2" caption="Results, Peer Support and Scheduling Sessions screens" width={4000} height={3000}/>

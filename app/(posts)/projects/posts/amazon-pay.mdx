...
summary: "Heuristic Evaluation and UI Redesign of Amazon Pay android application to find out why very few people use Amazon Pay in India."
media:
  thumbnail: "/amazon-pay/Thumb.webp"
---
...
<Image src="/amazon-pay/Survey.webp" alt="Survey Results" caption="Survey Results" width={4000} height={3000}/>
...
<Image src="/amazon-pay/problem1.webp" alt="Problem 1" caption="Problem 1" width={4000} height={3000}/>
<Image src="/amazon-pay/problem2.webp" alt="Problem 2" caption="Problem 2" width={4000} height={3000}/>
<Image src="/amazon-pay/problem3.webp" alt="Problem 3" caption="Problem 3" width={4000} height={3000}/>

## Competitor Analysis
**Apps that are primarily payment (UPI) apps. - Paytm and PhonePe**
<Image src="/amazon-pay/comp1.webp" alt="Paytm & Cred" caption="Paytm & PhonePe" width={4000} height={3000}/>
...
<Image src="/amazon-pay/comp2.webp" alt="WhatsApp, Cred and Groww" caption="WhatsApp, Cred and Groww" width={4000} height={3000}/>
...
<Image src="/amazon-pay/painpoints.webp" alt="User pain points" caption="User pain points" width={4000} height={3000}/>
...
<Image src="/amazon-pay/lo-fi.webp" alt="Low Fidelity Wireframes" caption="Low Fidelity Wireframes" width={4000} height={3000}/>
...
<Image src="/amazon-pay/Prototype_Homepage.webp" alt="Solution 2" caption="Redesigned Homepage — Original Screen vs Low-fidelity Wireframe vs Redesigned Screen" width={4000} height={3000}/>

<Image src="/amazon-pay/Prototype_AmazonPay.webp" alt="Solution 1" caption="Redesigned Pay Section — Original Screen vs Low-fidelity Wireframe vs Redesigned Screen" width={4000} height={3000}/>

## Final Mockups
<Image src="/amazon-pay/UI.webp" alt="UI" caption="Mockups" width={4000} height={3000}/>
